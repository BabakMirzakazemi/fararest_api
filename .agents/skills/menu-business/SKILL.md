...
## Purpose
Use this skill when implementing menu business services, contracts, and endpoints.

## Source of Truth
- Primary doc: docs/business/menu.md
- Index: docs/business/README.md

## Implementation Checklist
1. Read and summarize business scope and rules from docs/business/menu.md.
