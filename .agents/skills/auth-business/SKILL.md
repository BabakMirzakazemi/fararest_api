...
## Purpose
Use this skill when implementing auth business services, contracts, and endpoints.
...
1. Read and summarize business scope and rules from docs/business/auth.md.
