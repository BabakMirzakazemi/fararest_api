        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    parent_episode_id = table.Column<Guid>(type: "uuid", nullable: true),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_memory_episode", x => x.id);
                    table.ForeignKey(
                        name: "FK_memory_episode_memory_episode_parent_episode_id",
                        column: x => x.parent_episode_id,
                        principalTable: "memory_episode",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type = table.Column<int>(type: "integer", nullable: false),
                    reference_key = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    reference_label = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_memory_episode_reference", x => x.id);
                    table.ForeignKey(
                        name: "FK_memory_episode_reference_memory_episode_episode_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_memory_episode_tag", x => x.id);
                    table.ForeignKey(
                        name: "FK_memory_episode_tag_memory_episode_episode_id",
                        column: x => x.episode_id,
                        principalTable: "memory_episode",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_menu_category_menu_menu_id",
                        column: x => x.menu_id,
                        principalTable: "menu",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_commit_sha",
                table: "memory_episode",
                column: "commit_sha");

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_correlation_id",
                table: "memory_episode",
                column: "correlation_id");

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_deduplication_key",
                table: "memory_episode",
                column: "deduplication_key");

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_importance_occurred_at_utc",
                table: "memory_episode",
                columns: new[] { "importance", "occurred_at_utc" });

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_occurred_at_utc",
                table: "memory_episode",
                column: "occurred_at_utc");

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_parent_episode_id",
                table: "memory_episode",
                column: "parent_episode_id");

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_type_occurred_at_utc",
                table: "memory_episode",
                columns: new[] { "type", "occurred_at_utc" });

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_reference_episode_id_type_reference_key",
                table: "memory_episode_reference",
                columns: new[] { "episode_id", "type", "reference_key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_reference_type_reference_key",
                table: "memory_episode_reference",
                columns: new[] { "type", "reference_key" });

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_tag_episode_id_tag",
                table: "memory_episode_tag",
                columns: new[] { "episode_id", "tag" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_memory_episode_tag_tag",
                table: "memory_episode_tag",
                column: "tag");

            migrationBuilder.CreateIndex(
                name: "IX_menu_organization_id",
                table: "menu",
                column: "organization_id");

            migrationBuilder.CreateIndex(
                name: "IX_menu_organization_id_name",
                table: "menu",
                columns: new[] { "organization_id", "name" });

            migrationBuilder.CreateIndex(
                name: "IX_menu_category_menu_id",
                table: "menu_category",
                column: "menu_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_menu_item_organization_id_code",
                table: "menu_item",
                columns: new[] { "organization_id", "code" },
                unique: true);
