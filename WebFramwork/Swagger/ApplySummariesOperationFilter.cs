...
public class ApplySummariesOperationFilter : IOperationFilter
{
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        var parameterCount = parameters.Count(p => p.Name != "version" && p.Name != "api-version");
        ...
        else if (IsActionName("Post", "Create"))
        {
            ...
            SetFirstParameterDescription($"A {singularizeName} representation");
        }
        else if (IsActionName("Read", "Get"))
        {
            ...
            SetFirstParameterDescription($"a unique id for the {singularizeName}");
        }
        ...
        void SetFirstParameterDescription(string description)
        {
            ...
            if (!parameters[0].Description.HasValue())
            {
                parameters[0].Description = description;
            }
        }
        #endregion
    }
