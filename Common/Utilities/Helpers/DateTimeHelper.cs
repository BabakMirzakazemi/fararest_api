...
public static class DateTimeHelper
{
    ...
    public static DateTime GoToFirstDayOfShamsiMonth(this string date, string separator)
    {
        ...
        Thread.CurrentThread.CurrentCulture = new CultureInfo("en-US");
        DateTime objResult;
        objResult = pc.ToDateTime(Convert.ToInt16(dateParts[0]), Convert.ToInt16(dateParts[1]), Convert.ToInt16(day), 0, 0, 0, 0);

        return objResult;
    }

    public static DateTime GoToLastDayOfShamsiMonth(this string date, string separator)
    {
        var dateParts = date.Split(separator);
